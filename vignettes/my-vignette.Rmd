...
bibliography: library-mendeley.bib
csl: nature.csl
vignette: >
...
We impelement a null model function for bipartite graphs. A local rewiring algorithm is applied iteratively to generate a null model graph, which keep the degree distribution of the original graph and is otherwise random as much as possible. [@Squartini2011]
...
coeff <- list(alpha.mu = 0.2, alpha.sd = 0.15, beta0.mu = 0.95, beta0.sd = 0.15, beta1.mu = 0.03, beta1.sd = 0.02, gamma.mu = 1, gamma.sd = 0.2, h.mu = 0.2, h.sd = 0.1, delta = 0.5)
...
B = sim_ode_press(model = model_lv2, parms = parms, init = init, steps = 1000, stepwise = 0.1, extinct_threshold = extinct_threshold, perturb = perturb_growthrate, iter_steps = 150, isout = T, r.delta = 0.005)
